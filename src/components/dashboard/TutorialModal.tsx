...
const steps = [
  ...
  {
    image: "/tutorial/setGrid1.png",
    title: "Setting up the grid",
    description: "To change the size of the grid we press the \"set grid\" button."
  },
  {
    image: "/tutorial/setGrid2.png",
    title: "Setting up the grid",
    description: "We are prompted with a imput form where we are able to add any number of rows or columns on any side of the grid. When we are happy with changes we press apply."
  },
  {
    image: "/tutorial/editMode2.png",
  ...
  {
    image: "/tutorial/editMode3.png",
    title: "Editing the space",
    description: "To add plants to the grid, click the \"Add Plant\" button."
  },
  {
    image: "/tutorial/editMode4.png",
    title: "Editing the space",
    description: "A searchable list of available plants will appear. Simply find the plant you wish to add and click to select it."
  },
  {
    image: "/tutorial/editMode5.png",
    title: "Editing the space",
    description: "Use the mouse to highlight the cells where the selected plant should be placed. Once you're satisfied with the placement, click the \"Stop Planting\" button."
  },
    {
    image: "/tutorial/editMode6.png",
    title: "Saving the space",
